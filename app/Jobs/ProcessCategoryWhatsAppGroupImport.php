...
class ProcessCategoryWhatsAppGroupImport implements ShouldQueue, ShouldBeUnique
{
    ...
    {
        return 'category-whatsapp-group-import-process:'.$this->importId;
    }

    public function handle(CategoryWhatsAppGroupImportService $imports): void
    {
    ...
    {
        app(CategoryWhatsAppGroupImportService::class)->failImport($this->importId, $e);
    }
}
