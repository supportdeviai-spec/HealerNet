...
class PreviewCategoryWhatsAppGroupImport implements ShouldQueue, ShouldBeUnique
{
    ...
    {
        return 'category-whatsapp-group-import-preview:'.$this->token;
    }
    ...
    {
        app(CategoryWhatsAppGroupImportService::class)->failPreview($this->token, $e);
    }
}
